"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _child_process = require('child_process');
...
class NginxService {
  ...
  version() {
    try {
      const { error, stdout, status } = _child_process.spawnSync.call(void 0, 'nginx', ['-v']);
  ...
  restart() {
    if (this.version() !== false) {
      try {
        const { error, status } = _child_process.spawnSync.call(void 0, 'nginx', ['-s', 'reload']);
...
exports. default = new NginxService();
